...
knitr::include_graphics('https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcQwAm2GQeGQFvr4MkhidW57cC-nI4YQ0pFz0w&usqp=CAU')
```
...
Since the error rate is low at mtry =2.
Building final tree with most optimal customizations i.e., ntree=500, mtry=2 . 
```{r}
model2 <- randomForest(Outcome ~ ., data = diabetes_data, ntree = 500, mtry = 2)
print(model2)
```
